function OUTPUT = anis_model_Spherical_2D(T,param_fit,param_fixed,fixed,B,xdata,plotdata,mode)
...
switch mode
    ...
    case 'plot_Tdep'
        ...
        B0=0.5;        
        for t=1:length(Tv)
            [Mx_T(t),Mz_T(t),Mav_T(t)]=Calc_MT_2D(Ei,Tv(t),B,Theta,B0);
        end
       OUTPUT={M_x,M_z,M_av,Mx_T,Mz_T,Mav_T};
